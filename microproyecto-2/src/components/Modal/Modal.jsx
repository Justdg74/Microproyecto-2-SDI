...
export const Modal = ({children, state, changeState, title, language, genre, cast, sinopsis, director, fechaEstreno }) => {
  return (
    <div>
      {state && (
        <div className={styles.modalContainer}>
          <div className={styles.modalContent}>
            ...
            <button onClick = {() => changeState(false)} className={styles.modalButton}>
              <svg
            ...
            <h3 className = {styles.subtitle}>Fecha de Estreno: {fechaEstreno}</h3>
